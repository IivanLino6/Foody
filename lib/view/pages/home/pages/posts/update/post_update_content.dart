...
class PostUpdateContent extends StatelessWidget {
  PostUpdateViewModel vm;
  Post postArgs;
  PostUpdateContent(this.vm, this.postArgs);
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
              ...
              child: Container(
                height: 270,
                child: vm.state.image.isNotEmpty
                    ? Image(
                        image: NetworkImage(vm.state.image),
          ...
          Padding(
            padding:
                const EdgeInsets.only(top: 30, right: 12, left: 12, bottom: 12),
            child: DefaultFormField(
                initialValue: postArgs.name,
                txt: 'Name',
                onChanged: (value) {
                  vm.changeName(value);
                }),
          ...
          Padding(
            padding: const EdgeInsets.all(12.0),
            child: DefaultFormField(
                initialValue: postArgs.description,
                height: 50,
                txt: 'Description',
                onChanged: (value) {
